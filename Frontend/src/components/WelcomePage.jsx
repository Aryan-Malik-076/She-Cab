...
const WelcomePage = () => {
  return (
    <div className="flex justify-center items-center h-screen bg-gray-100 px-8">
      {/* Left Side: Text and Button (Moved Closer) */}
      <div className="flex-1 max-w-sm text-left ml-20"> {/* Added margin-left to move text forward */}
        <div className="flex items-center space-x-2">
          <span className="bg-black text-white text-sm font-semibold px-2 py-1 rounded">SheCab</span>
        </div>
        ...
        <button className="mt-4 bg-black text-white py-2 px-5 rounded-lg hover:bg-gray-900 transition duration-300">
          Join Now
        </button>
      </div>
